...
public class RedisCacheConfiguration {
  ...
  @Bean
  public ReactiveRedisTemplate<String, FilterEntity> reactiveRedisTemplate(
      ObjectMapper objectMapper) {

    var serializer = new Jackson2JsonRedisSerializer<>(objectMapper, FilterEntity.class);

    RedisSerializationContext.RedisSerializationContextBuilder<String, FilterEntity> builder =
        RedisSerializationContext.newSerializationContext(
            new Jackson2JsonRedisSerializer<>(String.class));

    RedisSerializationContext<String, FilterEntity> context = builder.value(serializer).build();
