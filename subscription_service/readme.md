...
SUBSCRIPTION_SERVICE_RABBITMQ_QUEUE=subscription_service_queue
SUBSCRIPTION_SERVICE_RABBITMQ_EXCHANGE=subscription_service_exchange
SUBSCRIPTION_SERVICE_RABBITMQ_R_KEY=subscription_service_routing_key
```
